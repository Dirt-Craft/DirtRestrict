...
public class Permission {
    public static final String COMMAND_MODIFY_BASE = "dirtrestrict.edit.base";
    public static final String COMMAND_MODIFY_ADD = "dirtrestrict.edit.add";
    public static final String COMMAND_MODIFY_META = "dirtrestrict.edit.meta";
