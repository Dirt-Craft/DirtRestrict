...
public class SetHidden implements SubCommand {
    public static final String ALIAS = "SetHidden";
    @Override
    ...
    public boolean onCommand(CommandSender p, Command command, String s, String[] args) {
        ...
        DirtRestrict.getInstance().getPreferences().setShowHidden((Player) p, set);
        p.sendMessage("§6You will now " + (set? "§2see" : "§4not see") + "§6 hidden bans.§r.");
