...
public class BannedItemCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        CompletableFuture.runAsync(()->runCommandAsync(sender, command, label, args));
        return true;
    }

    private void runCommandAsync(CommandSender sender, Command command, String label, String[] args){
